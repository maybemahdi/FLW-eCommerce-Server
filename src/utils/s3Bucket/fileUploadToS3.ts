...
import { fileFilter } from "../localDiskUpload/fileUploader";
...
/**
 * Middleware for uploading a single file using s3Uploader
 * Field name: 'file' (you can change it as needed)
 */
export const uploadSingle = s3Uploader.single("file");

/**
 * Optional: Middleware for uploading multiple files
 * Field name: 'files' (change or customize as needed)
 */
export const uploadMultiple = s3Uploader.array("files", 5);

// If needed: named fields for different form fields (like 'thumbnail', 'gallery')
export const uploadFields = s3Uploader.fields([
